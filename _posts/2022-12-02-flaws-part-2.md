...
## Level 4
<img src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*M-G9lXYoAtra3JAz89BKHQ.png">
...
<img src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*Ix_iOQs1rAE-Wt-bbeew-w.png">
...
<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*8_Pni_H8B_ooJ56PZjy-WQ.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*FSimt5CrwRjaTJx3xVaqcw.png'>

Confirm the EBS volume creation.

<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*8GupXtjcJeqf-wiXU7-isA.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*A5f0xAA0e0E41yBTJkl7sQ.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*Dq41xo59XhQd7PWRR2DhoQ.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*mq6ComuKrm4129Is4y-stA.png'>

<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*GyTvLvJyT6fgtl1Kl_jGJA.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*gNYkI7MsHi8FnzxBhu_9AQ.png'>

Using those credentials in the login page, we completed the challenge and get the link to advance to the next challenge.

<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*tPK41mSq2kFZM7AwOIGfjQ.png'>
...
## Level 5
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*M27r1UnEgXkGRHedIlg8LQ.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*y2ZnHNm-ivNkgf0GNjvW3g.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*M6j-yIJEJDGnvWQEj7R2FA.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*Ql_09rJ4d8GYkq6hfoY8hA.png'>

Adding the session token in the credentials of AWS directory.

<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*-eO5ajTtgQn-JroFqn6CaQ.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*Filyyy9JAkVF5l5CAnSBQg.png'>
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*JBMwoFsWXvppvb7-C1YRGA.png'>
...
## Level 6
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*85v5uEhlgy3D5ffJCw1m9w.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*irdqZ7IE4w8n0qVICZaftg.png'>

### Gathering User Information
Since, we have zero knowledge about this user, we can start with basic enumeration of the IAM user.

<img src='https://miro.medium.com/v2/resize:fit:640/format:webp/1*dkBnRRjecrkIs_trC3KZ_Q.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*nXlmGaolqeq6miiVh6wUcg.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*la0CMG3mrHMur7AVlOA1iw.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*DZ6xp14xFYyzSa8EjLAzlg.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*VQukeSJpCYZIlWavSpSoZw.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*DPkVIrIgC2_G1MD3rLj1sA.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*5kEVppGT1f-4lWYXw5E1Uw.png'>
...
<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*-_RqAPiqX--DXndUSkJWqg.png'>

Following the provided link from the API we reach the end of this challenges.

<img src='https://miro.medium.com/v2/resize:fit:720/format:webp/1*J5OsqOYIUVnkEwX5NbVMjw.png'>
